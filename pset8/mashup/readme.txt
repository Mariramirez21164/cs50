...
PHPLITEADMIN command to create table

https://www.reddit.com/r/cs50/comments/8qnsl0/pset_8_mashup_search_function_help/
Table 'places' has been created.
CREATE TABLE 'places' 
('country_code' TEXT, 'postal_code' TEXT, 'place_name' TEXT, 'admin_name1' TEXT,
'admin_code1' TEXT, 'admin_name2' TEXT, 'admin_code2' TEXT, 'admin_name3' TEXT, 'admin_code3' TEXT,
